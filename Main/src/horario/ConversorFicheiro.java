...
public class ConversorFicheiro {
	 ...
	 *
	 * O metodo usa a biblioteca JSON-java para analisar o ficheiro JSON e a
	...
	public static void convertJsonToCsv(String pathOrigem, String pathDestino) {
		...
		try {
		    ...
		    for (int i = 0; i < doc.length(); i++) {
		        ...
		        String hia = obj.getString("Hora in�cio da aula");
		        String hfa = obj.getString("Hora fim da aula");
		        String data = obj.getString("Data da aula");
		        String sala = obj.getString("Sala atribu�da � aula");
		        int lotacao = obj.getInt("Lota��o da sala");
